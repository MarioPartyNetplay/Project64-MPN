...
Purpose: Thread-safe cheat application for netplay sessions
Parameters: MMU - Memory management unit for accessing emulator memory
Author: Rewritten for netplay thread safety
...
void CCheats::ApplyCheatsForNetplay(CMipsMemoryVM * MMU)
{
    ...
    // Apply netplay cheats instead of regular cheats to avoid race conditions
...
Purpose: Load cheats from netplay data into separate array for thread safety
Parameters:
