...
enum MainMenuID
{
    ...
    ID_SYSTEM_SAVEAS, ID_SYSTEM_GSBUTTON,
    ...
    //Option Menu
    ID_OPTIONS_FULLSCREEN, ID_OPTIONS_FULLSCREEN2, ID_OPTIONS_ALWAYSONTOP, ID_OPTIONS_SETTINGS, ID_OPTIONS_CONFIG_GFX,
    ID_OPTIONS_CONFIG_AUDIO, ID_OPTIONS_CONFIG_CONT, ID_SYSTEM_CHEAT, ID_OPTIONS_CPU_USAGE,
    ID_OPTIONS_DISPLAY_FR, ID_OPTIONS_CHANGE_FR, ID_OPTIONS_INCREASE_SPEED,
    ...
    //Help Menu
    ID_HELP_STOCKHOMEPAGE, ID_HELP_ABOUTSETTINGFILES, ID_HELP_ABOUT,

    //Netplay
    ID_NETPLAY_REPLACESAVES, ID_NETPLAY_MPN, ID_NETPLAY_UPDATE_EMULATOR
};
